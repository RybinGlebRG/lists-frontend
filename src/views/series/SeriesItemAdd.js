...
export default function SeriesItemAdd(props){
    ...
    useEffect(()=>{
        let promises=[];
        promises.push(getAuthors());
        promises.push(BookRepository.getBookTypes());
        promises.push(loadSeriesItem(store.listId, store.seriesId));
